...
public class Level14 extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        task_text.setText(R.string.level14short);
    ...
    private void makeRndImages() {
        ...
        //Анимация
        final Animation an = AnimationUtils.loadAnimation(Level14.this, R.anim.alpha);

        while((numLeft = rnd.nextInt(10)) == numLeftOld) numLeft = rnd.nextInt(10);
        numLeftOld = numLeft;
        imgLeft.setImageResource(array.images14[numLeft]);
        imgLeft.setAnimation(an);
        left_text.setText(array.text14[numLeft]);

        numRight = rnd.nextInt(10);
        while(numRight == numLeft) {
            numRight = rnd.nextInt(10);
        }
        imgRight.setImageResource(array.images14[numRight]);
        imgRight.setAnimation(an);
        right_text.setText(array.text14[numRight]);
    }
...
//                Здесь кода нет
    ...
    private void previewDialog() {
        ...
        preview.setImageResource(R.drawable.previewimage14);
        //Фон
    ...
    private void dialogEnd() {
        ...
        tvDescription.setText(R.string.level14End);
