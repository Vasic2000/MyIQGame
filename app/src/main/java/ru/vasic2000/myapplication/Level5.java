...
public class Level5 extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        task_text.setText(R.string.level5short);
    ...
    private void makeRndImages() {
        ...
        //Анимация
        final Animation an = AnimationUtils.loadAnimation(Level5.this, R.anim.alpha);

        while((numLeft = rnd.nextInt(13)) == numLeftOld) numLeft = rnd.nextInt(13);
        numLeftOld = numLeft;
        imgLeft.setImageResource(array.images5[numLeft]);
        imgLeft.setAnimation(an);
        left_text.setText(array.text5[numLeft]);

        numRight = rnd.nextInt(13);
        while(numRight == numLeft) {
            numRight = rnd.nextInt(13);
        }
        imgRight.setImageResource(array.images5[numRight]);
        imgRight.setAnimation(an);
        right_text.setText(array.text5[numRight]);
    }
...
//                Здесь кода нет
    ...
    private void previewDialog() {
        ...
        preview.setImageResource(R.drawable.previewimage5);
        //Фон
        ...
        tvDescription.setText(R.string.level5);
...
//                Здесь кода нет
    ...
    private void dialogEnd() {
        ...
        tvDescription.setText(R.string.level5End);
