...
//        Фон
        ...
        task_text.setText(R.string.level10short);
    ...
    private void makeRndImages() {
        ...
        //Анимация
        final Animation an = AnimationUtils.loadAnimation(Level10.this, R.anim.alpha);

        while((numLeft = rnd.nextInt(24)) == numLeftOld) numLeft = rnd.nextInt(24);
        numLeftOld = numLeft;
        imgLeft.setImageResource(array.images10[numLeft]);
        imgLeft.setAnimation(an);
        left_text.setText(array.text10[numLeft]);

        numRight = rnd.nextInt(24);
        while(array.strong10[numLeft] == array.strong10[numRight]) {
            numRight = rnd.nextInt(24);
        }
        numLeftStrong = array.strong10[numLeft];
        numRightStrong = array.strong10[numRight];

        imgRight.setImageResource(array.images10[numRight]);
        imgRight.setAnimation(an);
        right_text.setText(array.text10[numRight]);
    }
...
//                Здесь кода нет
    ...
    private void previewDialog() {
        ...
        preview.setImageResource(R.drawable.previewimage10);
        //Фон
        ...
        tvDescription.setText(R.string.level10);
...
//                Здесь кода нет
    ...
    private void dialogEnd() {
        ...
        tvDescription.setText(R.string.level10End);
